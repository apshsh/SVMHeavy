...
class d_anion
{
    ...
    */
    ...
    friend d_anion operator-(const d_anion &left_op);
    friend d_anion &operator+=(d_anion  &left_op,       double                right_op);
    ...
    friend d_anion &operator-=(d_anion  &left_op, const std::complex<double> &right_op);
    friend d_anion &operator-=(d_anion  &left_op, const d_anion              &right_op);
    friend d_anion &leftmult(  d_anion  &left_op,       double                right_op);
    ...
    friend d_anion &rightmult(      double                left_op, d_anion &right_op);
    ...
    */
    ...
    /*
       ...
       (i,x)   - set element i to value x, return x
...
// real: 2.3_anion
// complex: 5.3_ianion
// quaternion: 9.5_iqanion, 4.5_jqanion, 3.2_kqanion
// octonion: 4.3_lanion etc

d_anion operator"" _anion(long double val);

d_anion operator"" _ianion(    long double val);
d_anion operator"" _iconjanion(long double val); // like -_ianion

d_anion operator"" _iqanion(long double valI);
d_anion operator"" _jqanion(long double valJ);
d_anion operator"" _kqanion(long double valK);

d_anion operator"" _lanion(long double vall);
d_anion operator"" _manion(long double valm);
d_anion operator"" _nanion(long double valn);
d_anion operator"" _oanion(long double valo);
d_anion operator"" _panion(long double valp);
d_anion operator"" _qanion(long double valq);
d_anion operator"" _ranion(long double valr);

d_anion operator"" _anion(unsigned long long int val);

d_anion operator"" _ianion(    unsigned long long int val);
d_anion operator"" _iconjanion(unsigned long long int val); // like -_ianion

d_anion operator"" _iqanion(unsigned long long int valI);
d_anion operator"" _jqanion(unsigned long long int valJ);
d_anion operator"" _kqanion(unsigned long long int valK);

d_anion operator"" _lanion(unsigned long long int vall);
d_anion operator"" _manion(unsigned long long int valm);
d_anion operator"" _nanion(unsigned long long int valn);
d_anion operator"" _oanion(unsigned long long int valo);
d_anion operator"" _panion(unsigned long long int valp);
d_anion operator"" _qanion(unsigned long long int valq);
d_anion operator"" _ranion(unsigned long long int valr);
...
inline d_anion  operator+(      double                left_op, const d_anion              &right_op);
inline d_anion  operator+(const std::complex<double> &left_op, const d_anion              &right_op);
inline d_anion  operator+(const d_anion              &left_op,       double                right_op);
...
inline int operator==(      double                left_op, const d_anion              &right_op);
...
// norm...(a):   returns the square of the (2) norm |a|^2 of a.
...
// pow(a,b):     returns the right power a^b - that is, exp(log(a)*b).*.**** (so I^J = K)
// sqrt(a):      returns the square root exp(log(a)/2) of a.*
// cbrt(a):      returns the cube root exp(log(a)/2) of a.*
//
...
// castrg(a):    returns the cas (cosine and sine) cas(a) = cos(a)+sin(a)
// casctrg(a):   returns the complementary cas (cosine and sine) cas(a) = cos(a)-sin(a)
// acastrg(a):   returns the inverse cas acos(x/sqrt(2))+pi/4
// acasctrg(a):  returns the inverse complementary cas acos(x/sqrt(2))-pi/4
//
