...
public:
    ...
    BLK_Nopnop(int xisIndPrune = 0) : BLK_Generic(xisIndPrune) { setaltx(nullptr); getKernel_unsafe().setType(0); getKernel_unsafe().setWeight(0_gent); resetKernel(); setsigma(0); return; }
