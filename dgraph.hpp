...
public:
    ...
    explicit Dgraph(const Vector<T> &xgnodes, const Matrix<S> &xedgeWeights);
...
template <class T, class S> double abs0  (const Dgraph<T,S> &a);
...
template <class T, class S> double &innerProduct       (double &res, const Dgraph<T,S> &a, const Dgraph<T,S> &b);
template <class T, class S> double &innerProductRevConj(double &res, const Dgraph<T,S> &a, const Dgraph<T,S> &b);
...
{
    NiceThrow("Random graph generation not supported");
...
template <class T, class S> double &innerProduct(double &res, const Dgraph<T,S> &a, const Dgraph<T,S> &b)
{
    NiceThrow("2-product undefined for graphs");
...
template <class T, class S> double &threeProduct(double &res, const Dgraph<T,S> &a, const Dgraph<T,S> &b, const Dgraph<T,S> &c)
{
    NiceThrow("3-product undefined for graphs");
...
template <class T, class S> double &fourProduct (double &res, const Dgraph<T,S> &a, const Dgraph<T,S> &b, const Dgraph<T,S> &c, const Dgraph<T,S> &d)
{
    NiceThrow("4-product undefined for graphs");
...
template <class T, class S> double &mProduct(double &res, int m, const Dgraph<T,S> *a)
{
    NiceThrow("m-product undefined for graphs");
