//TO DO: IF A NAN GETS PASSED AS AN X, THE USER IS ASKED TO FILL IT IN.  MAKES BOMUSE TRIVIAL TO IMPLIMENT
//HAVE A OPTIMIZATION METHOD -gbH WHICH IS BASICALLY "JUST ASK A HUMAN", THEN USE THIS IN -gbH 11
//NEW ONES:
//-gbH 18: ASK A HUMAN FOR x
//-gbH 19: LIKE 11, BUT YOU GIVE A BUNCH OF STRATEGIES LIKE [ 1 17 ] FOR EI AND GPUCB

//(also have -gbH 20 that uses the BO-Muse strategy)

//FIXME BUT NOW DOCUMENT THE MULTIFIDELITY SHIT!  AND IMPLEMENT FIDELITY OVER-RIDE
