...
double  h (double **X, int numVects, int dim,                        int *iind = nullptr);
double  hi(double **X, int numVects, int dim, double *y,             int *iind = nullptr);
double ehi(double **X, int numVects, int dim, double *mu, double *s, int *iind = nullptr);

double h(double **X, double *xmax, int numVects, int dim, int *axisind, int *iind = nullptr);
