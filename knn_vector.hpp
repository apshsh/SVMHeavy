...
public:
    ...
    virtual int gg(gentype &resg, int i, int retaltg = 0, gentype ***pxyprodi = nullptr) const override { Vector<double> tempresg; int ires = ggTrainingVectorInt(tempresg,i,retaltg,pxyprodi); resg = tempresg; return ires; }
