...
public:
    ...
    virtual int gh(gentype &resh, gentype &resg, const SparseVector<gentype> &x, int retaltg = 0, const vecInfo *xinf = nullptr, gentype ***pxyprodx = nullptr) const override { return LSV_Scalar::gh(resh,resg,x,retaltg,xinf,pxyprodx); }

    virtual double e(int i)                                                                           const override;
    virtual double e(const gentype &y, const SparseVector<gentype> &x, const vecInfo *xinf = nullptr) const override { return LSV_Scalar::e(y,x,xinf); }
