...
#ifndef _lsv_gentyp_h
#define _lsv_gentyp_h
...
// Implementation: just a glass-typewriter over SVM_Gentyp with appropriate
// setting mods
...
inline void qswap(LSV_Gentyp &a, LSV_Gentyp &b);
inline LSV_Gentyp &setzero(LSV_Gentyp &a);

class LSV_Gentyp : public LSV_Generic
{
public:
    ...
    LSV_Gentyp();
    LSV_Gentyp(const LSV_Gentyp &src);
    LSV_Gentyp(const LSV_Gentyp &src, const ML_Base *srcx);
    ...
    virtual       ML_Base &getML     (void)       override { return *this; }
    virtual const ML_Base &getMLconst(void) const override { return *this; }
    ...
    virtual int xspaceDim   (int k = -1) const override { return getQconst().xspaceDim(k);   }
    ...
    virtual int RFFordata(int i) const override { return getQconst().RFFordata(i); }
    ...
    virtual double K1ip(       int i, const gentype **pxyprod = nullptr, const SparseVector<gentype> *xx = nullptr, const vecInfo *xainfo = nullptr) const override { return  getQconst().K1ip(i,pxyprod,xx,xainfo); }
    virtual double K2ip(       int i, int j, const gentype **pxyprod = nullptr, const SparseVector<gentype> *xx = nullptr, const SparseVector<gentype> *yy = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *yyinfo = nullptr) const override { return getQconst().K2ip(i,j,pxyprod,xx,yy,xainfo,yyinfo); }
    ...
    virtual gentype        &K2(              gentype        &res, int ia, int ib                          , const gentype **pxyprod = nullptr, const SparseVector<gentype> *xx = nullptr, const SparseVector<gentype> *yy = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *yyinfo = nullptr, int resmode = 0) const override { return getQconst().K2(         res,ia,ib     ,pxyprod,xx,yy,xainfo,yyinfo,resmode); }
    virtual gentype        &K2(              gentype        &res, int ia, int ib, const gentype &bias     , const gentype **pxyprod = nullptr, const SparseVector<gentype> *xx = nullptr, const SparseVector<gentype> *yy = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *yyinfo = nullptr, int resmode = 0) const override { return getQconst().K2(         res,ia,ib,bias,pxyprod,xx,yy,xainfo,yyinfo,resmode); }
    virtual gentype        &K2(              gentype        &res, int ia, int ib, const MercerKernel &altK, const gentype **pxyprod = nullptr, const SparseVector<gentype> *xx = nullptr, const SparseVector<gentype> *yy = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *yyinfo = nullptr, int resmode = 0) const override { return getQconst().K2(         res,ia,ib,altK,pxyprod,xx,yy,xainfo,yyinfo,resmode); }
    virtual double          K2(                                   int ia, int ib                          , const gentype **pxyprod = nullptr, const SparseVector<gentype> *xx = nullptr, const SparseVector<gentype> *yy = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *yyinfo = nullptr, int resmode = 0) const override { return getQconst().K2(             ia,ib     ,pxyprod,xx,yy,xainfo,yyinfo,resmode); }
    virtual Matrix<double> &K2(int spaceDim, Matrix<double> &res, int ia, int ib                          , const gentype **pxyprod = nullptr, const SparseVector<gentype> *xx = nullptr, const SparseVector<gentype> *yy = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *yyinfo = nullptr, int resmode = 0) const override { return getQconst().K2(spaceDim,res,ia,ib     ,pxyprod,xx,yy,xainfo,yyinfo,resmode); }
    virtual d_anion        &K2(int order,    d_anion        &res, int ia, int ib                          , const gentype **pxyprod = nullptr, const SparseVector<gentype> *xx = nullptr, const SparseVector<gentype> *yy = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *yyinfo = nullptr, int resmode = 0) const override { return getQconst().K2(order,   res,ia,ib     ,pxyprod,xx,yy,xainfo,yyinfo,resmode); }
    ...
    virtual gentype        &Km(int m              , gentype        &res, Vector<int> &i                          , const gentype **pxyprod = nullptr, Vector<const SparseVector<gentype> *> *xx = nullptr, Vector<const vecInfo *> *xzinfo = nullptr, int resmode = 0) const override { return getQconst().Km(m         ,res,i     ,pxyprod,xx,xzinfo,resmode); }
    virtual gentype        &Km(int m              , gentype        &res, Vector<int> &i, const gentype &bias     , const gentype **pxyprod = nullptr, Vector<const SparseVector<gentype> *> *xx = nullptr, Vector<const vecInfo *> *xzinfo = nullptr, int resmode = 0) const override { return getQconst().Km(m         ,res,i,bias,pxyprod,xx,xzinfo,resmode); }
    virtual gentype        &Km(int m              , gentype        &res, Vector<int> &i, const MercerKernel &altK, const gentype **pxyprod = nullptr, Vector<const SparseVector<gentype> *> *xx = nullptr, Vector<const vecInfo *> *xzinfo = nullptr, int resmode = 0) const override { return getQconst().Km(m         ,res,i,altK,pxyprod,xx,xzinfo,resmode); }
    virtual double          Km(int m              ,                      Vector<int> &i                          , const gentype **pxyprod = nullptr, Vector<const SparseVector<gentype> *> *xx = nullptr, Vector<const vecInfo *> *xzinfo = nullptr, int resmode = 0) const override { return getQconst().Km(m             ,i     ,pxyprod,xx,xzinfo,resmode); }
    virtual Matrix<double> &Km(int m, int spaceDim, Matrix<double> &res, Vector<int> &i                          , const gentype **pxyprod = nullptr, Vector<const SparseVector<gentype> *> *xx = nullptr, Vector<const vecInfo *> *xzinfo = nullptr, int resmode = 0) const override { return getQconst().Km(m,spaceDim,res,i     ,pxyprod,xx,xzinfo,resmode); }
    virtual d_anion        &Km(int m, int order   , d_anion        &res, Vector<int> &i                          , const gentype **pxyprod = nullptr, Vector<const SparseVector<gentype> *> *xx = nullptr, Vector<const vecInfo *> *xzinfo = nullptr, int resmode = 0) const override { return getQconst().Km(m,order   ,res,i     ,pxyprod,xx,xzinfo,resmode); }
    ...
    virtual int addTrainingVector (int i, const gentype &z, const SparseVector<gentype> &x, double Cweigh = 1, double epsweigh = 1, int d = 2) override { return getQ().addTrainingVector (i,z,x,Cweigh,epsweigh,d); }
    virtual int qaddTrainingVector(int i, const gentype &z,       SparseVector<gentype> &x, double Cweigh = 1, double epsweigh = 1, int d = 2) override { return getQ().qaddTrainingVector(i,z,x,Cweigh,epsweigh,d); }

    virtual int addTrainingVector (int i, const Vector<gentype> &z, const Vector<SparseVector<gentype>> &x, const Vector<double> &Cweigh, const Vector<double> &epsweigh) override { return  getQ().addTrainingVector(i,z,x,Cweigh,epsweigh); }
    virtual int qaddTrainingVector(int i, const Vector<gentype> &z,       Vector<SparseVector<gentype>> &x, const Vector<double> &Cweigh, const Vector<double> &epsweigh) override { return getQ().qaddTrainingVector(i,z,x,Cweigh,epsweigh); }
    ...
    virtual int sety(int i, const gentype &z)                        override { return getQ().sety(i,z); }
    virtual int sety(const Vector<int> &i, const Vector<gentype> &z) override { return getQ().sety(i,z); }
    virtual int sety(const Vector<gentype> &z)                       override { return getQ().sety(z);   }

    virtual int sety(int                i, double                z) override { return getQ().sety(i,z); }
    virtual int sety(const Vector<int> &i, const Vector<double> &z) override { return getQ().sety(i,z); }
    virtual int sety(                      const Vector<double> &z) override { return getQ().sety(z); }

    virtual int sety(int                i, const Vector<double>         &z) override { return getQ().sety(i,z); }
    virtual int sety(const Vector<int> &i, const Vector<Vector<double>> &z) override { return getQ().sety(i,z); }
    virtual int sety(                      const Vector<Vector<double>> &z) override { return getQ().sety(z); }

    virtual int sety(int                i, const d_anion         &z) override { return getQ().sety(i,z); }
    virtual int sety(const Vector<int> &i, const Vector<d_anion> &z) override { return getQ().sety(i,z); }
    virtual int sety(                      const Vector<d_anion> &z) override { return getQ().sety(z); }

    virtual int setd(int i, int d)                               override { return getQ().setd(i,d); }
    virtual int setd(const Vector<int> &i, const Vector<int> &d) override { return getQ().setd(i,d); }
    virtual int setd(const Vector<int> &d)                       override { return getQ().setd(d);   }

    virtual int setCweight(int i, double xxCweight)                               override { return getQ().setCweight(i,xxCweight); }
    virtual int setCweight(const Vector<int> &i, const Vector<double> &xxCweight) override { return getQ().setCweight(i,xxCweight); }
    virtual int setCweight(const Vector<double> &xxCweight)                       override { return getQ().setCweight(xxCweight);   }

    virtual int setCweightfuzz(int i, double xxCweight)                               override { return getQ().setCweightfuzz(i,xxCweight); }
    virtual int setCweightfuzz(const Vector<int> &i, const Vector<double> &xxCweight) override { return getQ().setCweightfuzz(i,xxCweight); }
    virtual int setCweightfuzz(const Vector<double> &xxCweight)                       override { return getQ().setCweightfuzz(xxCweight);   }

    virtual int setsigmaweight(int i, double xxCweight)                               override { return getQ().setsigmaweight(i,xxCweight); }
    virtual int setsigmaweight(const Vector<int> &i, const Vector<double> &xxCweight) override { return getQ().setsigmaweight(i,xxCweight); }
    virtual int setsigmaweight(const Vector<double> &xxCweight)                       override { return getQ().setsigmaweight(xxCweight);   }

    virtual int setepsweight(int i, double xxepsweight)                               override { return getQ().setepsweight(i,xxepsweight); }
    virtual int setepsweight(const Vector<int> &i, const Vector<double> &xxepsweight) override { return getQ().setepsweight(i,xxepsweight); }
    virtual int setepsweight(const Vector<double> &xxepsweight)                       override { return getQ().setepsweight(xxepsweight);   }

    virtual int scaleCweight(double scalefactor)     override { return getQ().scaleCweight(scalefactor);     }
    virtual int scaleCweightfuzz(double scalefactor) override { return getQ().scaleCweightfuzz(scalefactor); }
    virtual int scalesigmaweight(double scalefactor) override { return getQ().scalesigmaweight(scalefactor); }
    virtual int scaleepsweight(double scalefactor)   override { return getQ().scaleepsweight(scalefactor);   }
    ...
    virtual int gg(               gentype &resg, int i, int retaltg = 0, gentype ***pxyprodi = nullptr) const override { return getQconst().gg(     resg,i,retaltg,pxyprodi); }
    virtual int hh(gentype &resh,                int i,                  gentype ***pxyprodi = nullptr) const override { return getQconst().hh(resh,     i,        pxyprodi); }
    virtual int gh(gentype &resh, gentype &resg, int i, int retaltg = 0, gentype ***pxyprodi = nullptr) const override { return getQconst().gh(resh,resg,i,retaltg,pxyprodi); }

    virtual double e(int i) const override { return getQconst().e(i); }
    ...
    virtual int predcov(gentype &resv_pred, gentype &resv, gentype &resmu, int ia, int ib, int ii, double sigmaweighti = 1.0                                                                                                                                                                           ) const override { return getQconst().predcov(resv_pred,resv,resmu,ia,ib,ii,sigmaweighti); }
    virtual int predcov(gentype &resv_pred, gentype &resv, gentype &resmu, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xx, double sigmaweighti = 1.0, const vecInfo *xainf = nullptr, const vecInfo *xbinf = nullptr, const vecInfo *xxinf = nullptr) const override { return getQconst().predcov(resv_pred,resv,resmu,xa,xb,xx,sigmaweighti,xainf,xbinf,xxinf); }

    virtual int cov(gentype &resv, gentype &resmu, int i, int j,                                                                                                                     gentype ***pxyprodi = nullptr, gentype ***pxyprodj = nullptr, gentype **pxyprodij = nullptr) const override { return getQconst().cov(resv,resmu,i,j,pxyprodi,pxyprodj,pxyprodij); }
    ...
    virtual int predvar(gentype &resv_pred, gentype &resv, gentype &resmu, int ia, int ii, double sigmaweighti = 1.0                                                                                                                  ) const override { return getQconst().predvar(resv_pred,resv,resmu,ia,ii,sigmaweighti); }
    virtual int predvar(gentype &resv_pred, gentype &resv, gentype &resmu, const SparseVector<gentype> &xa, const SparseVector<gentype> &xx, double sigmaweighti = 1.0, const vecInfo *xainf = nullptr, const vecInfo *xxinf = nullptr) const override { return getQconst().predvar(resv_pred,resv,resmu,xa,xx,sigmaweighti,xainf,xxinf); }
    ...
    virtual int setlevel(gentype &resv, gentype &resmu, int ia,                          double beta, double h) const override { return getQconst().setlevel(resv,resmu,ia,beta,h); }
    virtual int setlevel(gentype &resv, gentype &resmu, const SparseVector<gentype> &xa, double beta, double h) const override { return getQconst().setlevel(resv,resmu,xa,beta,h); }

    // Training data tracking functions:

    virtual const Vector<int>         &indKey         (int uu = -1) const override { return getQconst().indKey(uu);          }
    virtual const Vector<int>         &indKeyCount    (int uu = -1) const override { return getQconst().indKeyCount(uu);     }
    virtual const Vector<int>         &dattypeKey     (int uu = -1) const override { return getQconst().dattypeKey(uu);      }
    virtual const Vector<Vector<int>> &dattypeKeyBreak(int uu = -1) const override { return getQconst().dattypeKeyBreak(uu); }
    ...
    virtual int setgamma(const Vector<gentype> &newW) override { return getQ().setAlpha(newW); }
    virtual int setdelta(const gentype         &newB) override { return getQ().setBias(newB);  }

    // Additional information

    virtual int isVardelta (void) const override { return getQconst().isVarBias();   }
    virtual int isZerodelta(void) const override { return getQconst().isFixedBias(); }

    virtual const Vector<gentype> &gamma(void) const override { return getQconst().alpha(); }
    virtual const gentype         &delta(void) const override { return getQconst().bias();  }

    virtual const Matrix<double> &lsvGp(void) const override { return getQconst().Gp(); }

    // General modification and autoset functions

    virtual int setVardelta (void) override { return getQ().setVarBias();              }
    virtual int setZerodelta(void) override { gentype nv(biasV()); return getQ().setFixedBias(0.0*nv); }
    ...
    virtual       SVM_Gentyp &getQ(void)            { return grunt; }
    virtual const SVM_Gentyp &getQconst(void) const { return grunt; }
...
inline double norm2(const LSV_Gentyp &a);
inline double abs2 (const LSV_Gentyp &a);

inline double norm2(const LSV_Gentyp &a) { return a.RKHSnorm(); }
inline double abs2 (const LSV_Gentyp &a) { return a.RKHSabs();  }
...
inline void LSV_Gentyp::qswapinternal(ML_Base &bb)
{
    NiceAssert( isQswapCompat(*this,bb) );

    LSV_Gentyp &b = dynamic_cast<LSV_Gentyp &>(bb.getML());
...
inline void LSV_Gentyp::semicopy(const ML_Base &bb)
{
    NiceAssert( isSemicopyCompat(*this,bb) );

    const LSV_Gentyp &b = dynamic_cast<const LSV_Gentyp &>(bb.getMLconst());
...
inline void LSV_Gentyp::assign(const ML_Base &bb, int onlySemiCopy)
{
    NiceAssert( isAssignCompat(*this,bb) );

    const LSV_Gentyp &src = dynamic_cast<const LSV_Gentyp &>(bb.getMLconst());

    grunt.assign(src.grunt,onlySemiCopy);
