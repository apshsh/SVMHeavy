...
public:
    ...
    virtual int type   (void)  const override { return 509;          }
...
inline double norm2(const LSV_Planar &a);
inline double abs2 (const LSV_Planar &a);

inline double norm2(const LSV_Planar &a) { return a.RKHSnorm(); }
inline double abs2 (const LSV_Planar &a) { return a.RKHSabs();  }
