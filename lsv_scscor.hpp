...
public:
    ...
    virtual int type(void)    const override { return 505; }
...
inline double norm2(const LSV_ScScor &a);
inline double abs2 (const LSV_ScScor &a);

inline double norm2(const LSV_ScScor &a) { return a.RKHSnorm(); }
inline double abs2 (const LSV_ScScor &a) { return a.RKHSabs();  }
