...
//
// ML (machine learning) base type indirection
//
// Version: 7
// Date: 08/04/2016
...
#ifndef _ml_base_deref_h
#define _ml_base_deref_h
...
public:
    ...
    ML_Base_Deref(int _isIndPrune = 0) : ML_Base(_isIndPrune) { }
    ML_Base_Deref(const ML_Base_Deref &src, int _isIndPrune = 0) : ML_Base(_isIndPrune) { assign(src,_isIndPrune); }
    ML_Base_Deref(const ML_Base_Deref &src, const ML_Base *srcx, int _isIndPrune = 0) : ML_Base(_isIndPrune) { setaltx(srcx); assign(src,_isIndPrune); }
    ML_Base_Deref &operator=(const ML_Base_Deref &src) { assign(src); return *this; }
    virtual ~ML_Base_Deref() { }
    ...
    virtual       ML_Base &getML     (void)       override { return getQ().getML();           }
    virtual const ML_Base &getMLconst(void) const override { return getQconst().getMLconst(); }
    ...
    virtual gentype &K4(gentype &res, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xc, const SparseVector<gentype> &xdp, const vecInfo *xainf = nullptr, const vecInfo *xbinf = nullptr, const vecInfo *xcinf = nullptr, const vecInfo *xdpinf = nullptr) const override { return getQconst().K4(res,xa,xb,xc,xdp,xainf,xbinf,xcinf,xdpinf); }
    ...
    virtual double K4ip(       int ia, int ib, int ic, int id, const gentype **pxyprod = nullptr, const SparseVector<gentype> *xa = nullptr, const SparseVector<gentype> *xb = nullptr, const SparseVector<gentype> *xc = nullptr, const SparseVector<gentype> *xdp = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *xbinfo = nullptr, const vecInfo *xcinfo = nullptr, const vecInfo *xdpinfo = nullptr) const override { return getQconst().K4ip(ia,ib,ic,id,pxyprod,xa,xb,xc,xdp,xainfo,xbinfo,xcinfo,xdpinfo); }
    ...
    virtual gentype        &K4(              gentype        &res, int ia, int ib, int ic, int id                          , const gentype **pxyprod = nullptr, const SparseVector<gentype> *xa = nullptr, const SparseVector<gentype> *xb = nullptr, const SparseVector<gentype> *xc = nullptr, const SparseVector<gentype> *xdp = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *xbinfo = nullptr, const vecInfo *xcinfo = nullptr, const vecInfo *xdpinfo = nullptr, int resmode = 0) const override { return getQconst().K4(         res,ia,ib,ic,id     ,pxyprod,xa,xb,xc,xdp,xainfo,xbinfo,xcinfo,xdpinfo,resmode); }
    virtual gentype        &K4(              gentype        &res, int ia, int ib, int ic, int id, const gentype &bias     , const gentype **pxyprod = nullptr, const SparseVector<gentype> *xa = nullptr, const SparseVector<gentype> *xb = nullptr, const SparseVector<gentype> *xc = nullptr, const SparseVector<gentype> *xdp = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *xbinfo = nullptr, const vecInfo *xcinfo = nullptr, const vecInfo *xdpinfo = nullptr, int resmode = 0) const override { return getQconst().K4(         res,ia,ib,ic,id,bias,pxyprod,xa,xb,xc,xdp,xainfo,xbinfo,xcinfo,xdpinfo,resmode); }
    virtual gentype        &K4(              gentype        &res, int ia, int ib, int ic, int id, const MercerKernel &altK, const gentype **pxyprod = nullptr, const SparseVector<gentype> *xa = nullptr, const SparseVector<gentype> *xb = nullptr, const SparseVector<gentype> *xc = nullptr, const SparseVector<gentype> *xdp = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *xbinfo = nullptr, const vecInfo *xcinfo = nullptr, const vecInfo *xdpinfo = nullptr, int resmode = 0) const override { return getQconst().K4(         res,ia,ib,ic,id,altK,pxyprod,xa,xb,xc,xdp,xainfo,xbinfo,xcinfo,xdpinfo,resmode); }
    virtual double          K4(                                   int ia, int ib, int ic, int id                          , const gentype **pxyprod = nullptr, const SparseVector<gentype> *xa = nullptr, const SparseVector<gentype> *xb = nullptr, const SparseVector<gentype> *xc = nullptr, const SparseVector<gentype> *xdp = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *xbinfo = nullptr, const vecInfo *xcinfo = nullptr, const vecInfo *xdpinfo = nullptr, int resmode = 0) const override { return getQconst().K4(             ia,ib,ic,id     ,pxyprod,xa,xb,xc,xdp,xainfo,xbinfo,xcinfo,xdpinfo,resmode); }
    virtual Matrix<double> &K4(int spaceDim, Matrix<double> &res, int ia, int ib, int ic, int id                          , const gentype **pxyprod = nullptr, const SparseVector<gentype> *xa = nullptr, const SparseVector<gentype> *xb = nullptr, const SparseVector<gentype> *xc = nullptr, const SparseVector<gentype> *xdp = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *xbinfo = nullptr, const vecInfo *xcinfo = nullptr, const vecInfo *xdpinfo = nullptr, int resmode = 0) const override { return getQconst().K4(spaceDim,res,ia,ib,ic,id     ,pxyprod,xa,xb,xc,xdp,xainfo,xbinfo,xcinfo,xdpinfo,resmode); }
    virtual d_anion        &K4(int order,    d_anion        &res, int ia, int ib, int ic, int id                          , const gentype **pxyprod = nullptr, const SparseVector<gentype> *xa = nullptr, const SparseVector<gentype> *xb = nullptr, const SparseVector<gentype> *xc = nullptr, const SparseVector<gentype> *xdp = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *xbinfo = nullptr, const vecInfo *xcinfo = nullptr, const vecInfo *xdpinfo = nullptr, int resmode = 0) const override { return getQconst().K4(order   ,res,ia,ib,ic,id     ,pxyprod,xa,xb,xc,xdp,xainfo,xbinfo,xcinfo,xdpinfo,resmode); }
    ...
    virtual void dK(gentype &xygrad, gentype &xnormgrad, int ia, int ib, const gentype **pxyprod = nullptr, const SparseVector<gentype> *xx = nullptr, const SparseVector<gentype> *yy = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *yyinfo = nullptr, int deepDeriv = 0) const override { getQconst().dK(xygrad,xnormgrad,ia,ib,     pxyprod,xx,yy,xainfo,yyinfo,deepDeriv); }
    virtual void dK(double  &xygrad, double  &xnormgrad, int ia, int ib, const gentype **pxyprod = nullptr, const SparseVector<gentype> *xx = nullptr, const SparseVector<gentype> *yy = nullptr, const vecInfo *xainfo = nullptr, const vecInfo *yyinfo = nullptr, int deepDeriv = 0) const override { getQconst().dK(xygrad,xnormgrad,ia,ib,     pxyprod,xx,yy,xainfo,yyinfo,deepDeriv); }
    ...
    virtual void K4xfer(                                    gentype &res, int &minmaxind, int typeis, const gentype &xyprod, const gentype &yxprod, const gentype &diffis, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xc, const SparseVector<gentype> &xdp, const vecInfo &xainfo, const vecInfo &xbinfo, const vecInfo &xcinfo, const vecInfo &xdpinfo, int ia, int ib, int ic, int id, int xdim, int densetype, int resmode, int mlid) const override { getQconst().K4xfer(res,minmaxind,typeis,xyprod,yxprod,diffis,xa,xb,xc,xdp,xainfo,xbinfo,xcinfo,xdpinfo,ia,ib,ic,id,xdim,densetype,resmode,mlid); }
    ...
    virtual void K4xfer(                                  double &res, int &minmaxind, int typeis, double xyprod, double yxprod, double diffis, const SparseVector<gentype> &xa, const SparseVector<gentype> &xb, const SparseVector<gentype> &xc, const SparseVector<gentype> &xdp, const vecInfo &xainfo, const vecInfo &xbinfo, const vecInfo &xcinfo, const vecInfo &xdpinfo, int ia, int ib, int ic, int id, int xdim, int densetype, int resmode, int mlid) const override { getQconst().K4xfer(res,minmaxind,typeis,xyprod,yxprod,diffis,xa,xb,xc,xdp,xainfo,xbinfo,xcinfo,xdpinfo,ia,ib,ic,id,xdim,densetype,resmode,mlid); }
    ...
    virtual int noisevar(gentype &resv, gentype &resmu, int i,                           const SparseVector<gentype> &xvar, int u = -1,                                 gentype ***pxyprodi = nullptr, gentype **pxyprodii = nullptr) const override { return getQconst().noisevar(resv,resmu,i,xvar,u,pxyprodi,pxyprodii); }
    ...
    virtual int noisecov(gentype &resv, gentype &resmu, int i,                           int j,                           const SparseVector<gentype> &xvar, int u = -1,                                                                 gentype ***pxyprodi = nullptr, gentype ***pxyprodj = nullptr, gentype **pxyprodij = nullptr) const override { return getQconst().noisecov(resv,resmu,i,j,xvar,u,pxyprodi,pxyprodj,pxyprodij); }
