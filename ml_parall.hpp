...
public:
    ...
    ParallBackcall(ML_Parall *xowner = nullptr);
...
inline double norm2(const ML_Parall &a);
inline double abs2 (const ML_Parall &a);

inline double norm2(const ML_Parall &a) { return a.RKHSnorm(); }
inline double abs2 (const ML_Parall &a) { return a.RKHSabs();  }
