...
inline double norm2(const ML_Pool &a);
inline double abs2 (const ML_Pool &a);

inline double norm2(const ML_Pool &a) { return a.RKHSnorm(); }
inline double abs2 (const ML_Pool &a) { return a.RKHSabs();  }
