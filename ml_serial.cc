...
int SerialBackcall::gvTrainingVector(gentype &resv, int ii) const
{
    ...
    if ( numLayers() == 1 )
    {
        res = ((*((owner->theML)(0)))).gv(resv,BLK_Nopnop::getx(ii));
    }
    ...
    else
    {
        ...
        res = ((*((owner->theML)(0)))).gh(temph,tempg,BLK_Nopnop::getx(ii));
...
/*int SerialBackcall::gvTrainingVector(Matrix<gentype> &resv, int Nx, int dummy) const
{
    ...
    if ( numLayers() == 1 )
    {
        res = ((*((owner->theML)(0)))).gv(resv,Nx,dummy);
    }
...
int SerialBackcall::ghTrainingVector(gentype &resh, gentype &resg, int ii, int retaltg) const
{
    ...
    if ( numLayers() == 1 )
    {
        res = ((*((owner->theML)(0)))).gh(resh,resg,BLK_Nopnop::getx(ii),retaltg);
    }
    ...
    else
    {
        ...
        res = ((*((owner->theML)(0)))).gg(tempg,BLK_Nopnop::getx(ii));
...
int SerialBackcall::ggTrainingVector(double &resg, int ii, int retaltg) const
{
    ...
    if ( numLayers() == 1 )
    {
        res = ((*((owner->theML)(0)))).gg(resg,BLK_Nopnop::getx(ii),retaltg);
    }
...
void SerialBackcall::dgTrainingVector(SparseVector<gentype> &resx, int ii) const
{
    if ( numLayers() == 1 )
    {
        ((*((owner->theML)(0)))).dg(resx,BLK_Nopnop::y(ii),BLK_Nopnop::getx(ii));
    }
    ...
    else
    {
        ...
        ((*((owner->theML)(0)))).dg(resx,BLK_Nopnop::y(ii),BLK_Nopnop::getx(ii));
        ((*((owner->theML)(0)))).gh(temph,tempg,BLK_Nopnop::getx(ii));
