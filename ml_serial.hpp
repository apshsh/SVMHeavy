...
public:
    ...
    SerialBackcall(ML_Serial *xowner = nullptr);
...
inline double norm2(const ML_Serial &a);
inline double abs2 (const ML_Serial &a);

inline double norm2(const ML_Serial &a) { return a.RKHSnorm(); }
inline double abs2 (const ML_Serial &a) { return a.RKHSabs();  }
