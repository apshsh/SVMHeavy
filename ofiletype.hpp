...
inline ofiletype &setident (ofiletype &a) { NiceThrow("Whatever"); return a; }
inline ofiletype &setposate(ofiletype &a) { return a; }
inline ofiletype &setnegate(ofiletype &a) { NiceThrow("I reject your reality and substitute my own"); return a; }
inline ofiletype &setconj  (ofiletype &a) { NiceThrow("Mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm"); return a; }
inline ofiletype &setrand  (ofiletype &a) { NiceThrow("Blippity Blappity Blue"); return a; }
