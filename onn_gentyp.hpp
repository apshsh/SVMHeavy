...
public:
    ...
    virtual int type(void)    const override { return 105;           }
...
inline double norm2(const ONN_Gentyp &a);
inline double abs2 (const ONN_Gentyp &a);

inline double norm2(const ONN_Gentyp &a) { return a.RKHSnorm(); }
inline double abs2 (const ONN_Gentyp &a) { return a.RKHSabs();  }
