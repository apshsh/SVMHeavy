...
int optLinState::maxGradNonOpt(int &alphaZIndex, int &eFIndex, double &gradmag, const Matrix<double> &, const Vector<double> &, const Vector<double> &)
{
    //(void) G;
    //(void) c;
    //(void) g;
...
void optLinState::fixalphaGradBad(const Matrix<double> &G, const Vector<double> &c, const Vector<double> &)
{
    NiceAssert( G.numRows() == eN() );
    NiceAssert( G.numCols() == aN() );
    NiceAssert( c.size() == aN() );
...
void optLinState::fixeBad(const Matrix<double> &G, const Vector<double> &, const Vector<double> &g)
{
    NiceAssert( G.numRows() == eN() );
    NiceAssert( G.numCols() == aN() );
    //NiceAssert( c.size() == aN() );
...
void optLinState::recalcAlphaGrad(const Matrix<double> &G, const Vector<double> &c, const Vector<double> &)
{
    NiceAssert( G.numRows() == eN() );
    NiceAssert( G.numCols() == aN() );
    NiceAssert( c.size() == aN() );
...
void optLinState::recalce(const Matrix<double> &G, const Vector<double> &, const Vector<double> &g)
{
    NiceAssert( G.numRows() == eN() );
    NiceAssert( G.numCols() == aN() );
    //NiceAssert( c.size() == aN() );
...
void optLinState::recalcAlphaGrad(int i, const Matrix<double> &G, const Vector<double> &c, const Vector<double> &)
{
    NiceAssert( G.numRows() == eN() );
    NiceAssert( G.numCols() == aN() );
    NiceAssert( c.size() == aN() );
...
void optLinState::recalce(int i, const Matrix<double> &G, const Vector<double> &, const Vector<double> &g)
{
    NiceAssert( G.numRows() == eN() );
    NiceAssert( G.numCols() == aN() );
    //NiceAssert( c.size() == aN() );
    ...
    twoProduct(de("&",i),G(i,tmpva,tmpvb),dalpha);
    de("&",i) += g(i);
...
void optLinState::recalcb(const Matrix<double> &G, const Vector<double> &c, const Vector<double> &)
{
    //(void) g;
