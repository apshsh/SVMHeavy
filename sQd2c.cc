...
int solve_d2c(svmvolatile int &killSwitch, optState<double,double> &x,
...
//    double stepscale = stepscalefactor;
	...
	{
            NiceThrow("Nonfeasible start not enabled for d2c");
	...
	//res = solve_d2c(killSwitch,x,Gp,Gpsigma,Gn,Gpn,gp,gn,hp,lb,ub,maxitcnt,maxruntime,runtimeend,nullptr,nullptr,1.0);
	res = solve_d2c(killSwitch,x,Gp,Gpsigma,Gn,Gpn,gp,gn,hp,lb,ub,sc,nullptr,nullptr,1.0);
    }
    ...
    */
        ...
        for ( i = 0 ; i < x.aN() ; ++i )
	{
        ...
        */
        ...
        if ( ( !(max_pos_pos(0)) || ( max_pos_val(0) <  x.opttol() ) ) &&
             ( !(max_neg_pos(0)) || ( max_neg_val(0) > -x.opttol() ) )    )
        {
            break;
        }
        ...
        */
        ...
        sc.testopt(itcnt,isopt,timeout,bailout,stopout,kickstart,FEEDBACK_CYCLE,MAJOR_FEEDBACK_CYCLE,start_time,curr_time,"D2C (sQd2c) optimisation",uservars,varnames,vardescr);
    }
