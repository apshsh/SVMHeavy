...
public:
        ...
        const Vector<double> &_lb, const Vector<double> &_ub, const Vector<double> &_qGpnRowTwoMag)
    {
        ...
        MEMNEW(res,fullOptStateSMO(x,_qGp,_qGpsigma,_qGn,_qGpn,_gp,_gn,_hp,_lb,_ub,_qGpnRowTwoMag));
...
int examineExample_SMO(int i2, int tau2, int &f_zero, optState<double,double> &probdef, const Matrix<double> &Gp, const Matrix<double> &Gpsigma, const Matrix<double> &Gn, const Matrix<double> &Gpn, const Vector<double> &gp, const Vector<double> &gn, const Vector<double> &hp, const Vector<double> &lb, const Vector<double> &ub, double (*fixHigherOrderTerms)(optState<double,double> &x, void *, const Vector<double> &, const Vector<double> &, double &) = nullptr, void *htArg = nullptr, double stepscalefactor = 1.0);
int takeStep_SMO(int i1, int i2, int tau1, int tau2, double &E1, double &E2, optState<double,double> &probdef, const Matrix<double> &Gp, const Matrix<double> &Gpsigma, const Matrix<double> &Gn, const Matrix<double> &Gpn, const Vector<double> &gp, const Vector<double> &gn, const Vector<double> &hp, const Vector<double> &lb, const Vector<double> &ub, double (*fixHigherOrderTerms)(optState<double,double> &x, void *, const Vector<double> &, const Vector<double> &, double &) = nullptr, void *htArg = nullptr, double stepscalefactor = 1.0);
int trial_step_SMO(double &d_J_epart, int i1, int i2, int tau1, int tau2, double &e1, double &e2, double &d_alpha1, double &d_alpha2, double &d_b, optState<double,double> &probdef, const Matrix<double> &Gp, const Matrix<double> &Gpsigma, const Matrix<double> &Gn, const Matrix<double> &Gpn, const Vector<double> &gp, const Vector<double> &gn, const Vector<double> &hp, const Vector<double> &lb, const Vector<double> &ub, double (*fixHigherOrderTerms)(optState<double,double> &x, void *, const Vector<double> &, const Vector<double> &, double &) = nullptr, void *htArg = nullptr, double stepscalefactor = 1.0);
int actually_take_step_SMO(int i1, int i2, int tau1, int tau2, double &d_alpha1, double &d_alpha2, double &d_b, optState<double,double> &probdef, const Matrix<double> &Gp, const Matrix<double> &Gpsigma, const Matrix<double> &Gn, const Matrix<double> &Gpn, const Vector<double> &gp, const Vector<double> &gn, const Vector<double> &hp, const Vector<double> &lb, const Vector<double> &ub, double (*fixHigherOrderTerms)(optState<double,double> &x, void *, const Vector<double> &, const Vector<double> &, double &) = nullptr, void *htArg = nullptr, double stepscalefactor = 1.0);
