...
const double &fnConstElm(int i, int j, const void *args, retVector<double> &tmp);
const double &fnValsElm (int i, int j, const void *args, retVector<double> &tmp);
const double &fnDiagElm (int i, int j, const void *args, retVector<double> &tmp);
const double &fnOuterElm(int i, int j, const void *args, retVector<double> &tmp);
const double &fnReflElm (int i, int j, const void *args, retVector<double> &tmp);
const double &fnRotatElm(int i, int j, const void *args, retVector<double> &tmp);
...
const Vector<double> &fnDiagRow (int i, const void *args, retVector<double> &tmp);
const Vector<double> &fnOuterRow(int i, const void *args, retVector<double> &tmp);
const Vector<double> &fnReflRow (int i, const void *args, retVector<double> &tmp);
const Vector<double> &fnRotatRow(int i, const void *args, retVector<double> &tmp);
...
const double &fnConstElm(int i, int j, const void *args, retVector<double> &)
{
...
const Vector<double> &fnConstRow(int i, const void *args, retVector<double> &)
{
    void **tempargs = (void **) args;
...
const double &fnValsElm(int i, int j, const void *args, retVector<double> &)
{
    (void) i;
    (void) j;
...
const Vector<double> &fnValsRow(int i, const void *args, retVector<double> &)
{
    (void) i;
...
const double &fnDiagElm(int i, int j, const void *args, retVector<double> &)
{
    void **tempargs = (void **) args;
...
const Vector<double> &fnDiagRow(int i, const void *args, retVector<double> &)
{
    void **tempargs = (void **) args;
...
const double &fnOuterElm(int i, int j, const void *args, retVector<double> &)
{
    NiceAssert(args);
...
const Vector<double> &fnOuterRow(int i, const void *args, retVector<double> &)
{
    NiceAssert(args);
...
const double &fnReflElm(int i, int j, const void *args, retVector<double> &)
{
...
const Vector<double> &fnReflRow(int i, const void *args, retVector<double> &)
{
...
const double &fnRotatElm(int i, int j, const void *args, retVector<double> &)
{
    if ( i && j )
    {
...
const Vector<double> &fnRotatRow(int i, const void *args, retVector<double> &tmpv)
{
    (void) i;
	...
	(*((Vector<double> *) (((void **) args)[1])))("&",1,1,((*((Vector<double> *) (((void **) args)[1]))).size())-1,tmpv)  = (*((Vector<double> *) (((void **) args)[2])));
	(*((Vector<double> *) (((void **) args)[1])))("&",1,1,((*((Vector<double> *) (((void **) args)[1]))).size())-1,tmpv) *= (*(((double **) (((void **) args)[3]))[1]));
	...
	(*((Vector<double> *) (((void **) args)[1])))("&",1,1,((*((Vector<double> *) (((void **) args)[1]))).size())-1,tmpv)  = (*((Vector<double> *) (((void **) args)[2])));
	(*((Vector<double> *) (((void **) args)[1])))("&",1,1,((*((Vector<double> *) (((void **) args)[1]))).size())-1,tmpv) *= (*(((double **) (((void **) args)[3]))[0]));
    }
...
const double &fnCutMElm(int i, int j, const void *args, retVector<double> &)
{
...
const Vector<double> &fnCutMRow(int i, const void *args, retVector<double> &)
{
    if ( ( (*(((int **) (((void **) args)[3]))[0])) == -1 ) && ( (*(((int **) (((void **) args)[3]))[1])) == -1 ) )
    {
	if ( ( (*((Matrix<double> *) (((void **) args)[4]))).numRows() != ((int *) (((void **) args)[1]))[0]+1 ) || ( (*((Matrix<double> *) (((void **) args)[4]))).numCols() != ((int *) (((void **) args)[1]))[0]+1 ) )
...
const double &fnStackElm(int i, int j, const void *args, retVector<double> &)
{
...
const Vector<double> &fnStackRow(int i, const void *args, retVector<double> &tmp)
{
    ...
    retVector<double> tmpbunused;

    if ( i < A.numRows() )
    {
        return A(i,0,1,m-1,tmp,Aret("&",i));
    }

    return B(i-(A.numRows()),0,1,m-1,tmp,Bret("&",i-(A.numRows())));
}
