...
SSV_Generic::SSV_Generic() : SVM_Scalar()
{
    ...
    zmodel.setFixedBias(0.0); // Bias is within model (see addTrainingVector below)
...
//    }
    ...
    NiceThrow("Km (m>4) not defined for kssv_callback");
                           ...
                           int xdim, int densetype, int resmode, int mlid) const
{
    ...
    NiceThrow("K4 not defined for kssv_callback");
                           ...
                           int xdim, int densetype, int resmode, int mlid) const
{
    ...
    NiceThrow("K3 not defined for kssv_callback");
                           ...
                           int xdim, int densetype, int resmode, int mlid) const
{
    ...
    NiceThrow("K1 not defined for kssv_callback");
                           ...
                           int xdim, int densetype, int resmode, int mlid) const
{
    ...
    NiceThrow("K0 not defined for kssv_callback");
                           ...
                           int xdim, int m, int densetype, int resmode, int mlid) const
{
    ...
    Kmxfer(temp,minmaxind,typeis,gxyprod,gyxprod,gdiffis,x,xinfo,ii,xdim,m,densetype,resmode,mlid);
                           ...
                           int xdim, int densetype, int resmode, int mlid) const
{
    ...
    K2xfer(tempa,tempb,temp,minmaxind,typeis,gxyprod,gyxprod,gdiffis,xa,xb,xainfo,xbinfo,i,j,xdim,densetype,resmode,mlid);
                           ...
                           int xdim, int densetype, int resmode, int mlid) const
{
    ...
    K0xfer(temp,minmaxind,typeis,gxyprod,gyxprod,gdiffis,xdim,densetype,resmode,mlid);
...
int SSV_Generic::setb(double newb) 
{ 
    zb = newb; 
...
int SSV_Generic::getparam(int ind, gentype &val, const gentype &xa, int ia, const gentype &xb, int ib, charptr &desc) const
{
    int res = 0;
    ...
    switch ( ind )
    {
        case 8000: { val = Nzs();                    desc = "SSV_Generic::Nzs"; break; }
        case 8001: { val = beta();                   desc = "SSV_Generic::beta"; break; }
        case 8002: { val = b();                      desc = "SSV_Generic::b"; break; }
        case 8003: { val = zmin()(tmpva);            desc = "SSV_Generic::zmin"; break; }
        case 8004: { val = zmax()(tmpva);            desc = "SSV_Generic::zmax"; break; }
        case 8005: { val = xstate();                 desc = "SSV_Generic::xstate"; break; }
        case 8006: { val = xact();                   desc = "SSV_Generic::xact"; break; }
        case 8007: { val = M();                      desc = "SSV_Generic::M"; break; }
        case 8008: { val = n();                      desc = "SSV_Generic::n"; break; }
        case 8009: { val = isQuadRegul();            desc = "SSV_Generic::isQuadRegul"; break; }
        case 8010: { val = isLinRegul();             desc = "SSV_Generic::isLinRegul"; break; }
        case 8011: { val = biasForce();              desc = "SSV_Generic::biasForce"; break; }
        case 8012: { val = anomalclass();            desc = "SSV_Generic::anomalclass"; break; }
        case 8013: { val = ssvlr();                  desc = "SSV_Generic::ssvlr"; break; }
        case 8014: { val = ssvmom();                 desc = "SSV_Generic::ssvmom"; break; }
        case 8015: { val = ssvtol();                 desc = "SSV_Generic::ssvtol"; break; }
        case 8016: { val = ssvovsc();                desc = "SSV_Generic::ssvovsc"; break; }
        case 8017: { val = ssvmaxitcnt();            desc = "SSV_Generic::ssvmaxitcnt"; break; }
        case 8018: { val = ssvmaxtime();             desc = "SSV_Generic::xxvmaxtime"; break; }

        case 8100: { val = z((int) xa)(tmpvb); desc = "SSV_Generic::z"; break; }
