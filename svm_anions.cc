...
void AtoVvect(const Vector<gentype> &src, Vector<Vector<double> > &dest)
{
    ...
    if ( dest.size() )
    {
        ...
        for ( i = 0 ; i < dest.size() ; ++i )
        {
            AtoV((const d_anion &) src(i),dest("&",i));
        }
    }
...
int SVM_Anions::addtspaceFeat(int iii)
{
    ...
    NiceThrow("Function addtspaceFeat has no meaning in anionic context.");
...
int SVM_Anions::removetspaceFeat(int iii)
{
    ...
    NiceThrow("Function removetspaceFeat has no meaning in anionic context.");
...
int SVM_Anions::removeTrainingVector(int i, int num)
{
    int res = 0;
    gentype y;
...
std::ostream &SVM_Anions::printstream(std::ostream &output, int dep) const
{
    ...
    repPrint(output,'>',dep) << "Targetsgen: " << traintarggen << "\n";
...
std::istream &SVM_Anions::inputstream(std::istream &input)
{
    ...
    input >> dummy; input >> traintarggen;
...
int SVM_Anions::setAlphaV(const Vector<Vector<double> > &newAlpha)
{
    ...
    NiceThrow("Function setAlphaV not available for this SVM type.");
...
int SVM_Anions::setBiasV(const Vector<double> &newBias)
{
    ...
    NiceThrow("Function setBiasV not available for this SVM type.");
...
int SVM_Anions::sety(int i, const Vector<double> &z)
{
    ...
    NiceThrow("Function sety not available for this SVM type.");
...
int SVM_Anions::addTrainingVector( int i, const Vector<double> &z, const SparseVector<gentype> &x, double Cweigh, double epsweigh, int d)
{
    ...
    NiceThrow("Function addTrainingVector not available for this SVM type.");
...
int SVM_Anions::qaddTrainingVector(int i, const Vector<double> &z,       SparseVector<gentype> &x, double Cweigh, double epsweigh, int d)
{
    ...
    NiceThrow("Function qaddTrainingVector not available for this SVM type.");
...
int SVM_Anions::prealloc(int expectedN)
{
    ...
    traintarggen.prealloc(expectedN);
