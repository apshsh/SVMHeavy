...
public:
    ...
    virtual double e(int i)                                                                           const override { return SVM_Vector::e(i);        }
    virtual double e(const gentype &y, const SparseVector<gentype> &x, const vecInfo *xinf = nullptr) const override { return SVM_Vector::e(y,x,xinf); }
