...
inline double norm2(const SVM_BiRank &a);
inline double abs2 (const SVM_BiRank &a);

inline double norm2(const SVM_BiRank &a) { return a.RKHSnorm(); }
inline double abs2 (const SVM_BiRank &a) { return a.RKHSabs();  }
