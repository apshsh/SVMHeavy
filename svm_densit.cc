...
int SVM_Densit::addTrainingVector (int i, double z, const SparseVector<gentype> &xx, double Cweigh, double epsweigh, int d)
{
    ...
    NiceThrow("addTrainingVector with z not defined for density estimation");
...
int SVM_Densit::qaddTrainingVector(int i, double z,       SparseVector<gentype> &x, double Cweigh, double epsweigh, int d)
{
    ...
    NiceThrow("qaddTrainingVector with z not defined for density estimation");
...
int SVM_Densit::gTrainingVector(double &res, int &unusedvar, int i, int retaltg, gentype ***pxyprodi) const
{
