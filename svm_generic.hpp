...
public:
    ...
    virtual const Vector<Vector<int>> &ClassRep(void)  const { const thread_local Vector<Vector<int>> dummy; return dummy; }
    ...
    virtual const gentype &costfnfuzzt (void) const { const thread_local gentype temp(DEFAULT_COSTFNFUZZT); return temp; }
