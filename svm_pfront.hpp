...
public:
    ...
    virtual int restart(void) override { SVM_PFront temp; *this = temp; return 1; }
    ...
    virtual int type(void)    const override { return 8; }
    ...
    virtual int gh(gentype &resh, gentype &resg, const SparseVector<gentype> &x, int retaltg = 0, const vecInfo *xinf = nullptr, gentype ***pxyprodx = nullptr) const override { return SVM_Binary::gh(resh,resg,x,retaltg,xinf,pxyprodx); }
...
inline double norm2(const SVM_PFront &a);
inline double abs2 (const SVM_PFront &a);

inline double norm2(const SVM_PFront &a) { return a.RKHSnorm(); }
inline double abs2 (const SVM_PFront &a) { return a.RKHSabs();  }
