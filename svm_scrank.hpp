...
private:
    ...
    void setGpnExt(Matrix<double> *GpnExtOld, Matrix<double> *GpnExtNew) { (void) GpnExtOld; (void) GpnExtNew; NiceThrow("setGpnExt blocked in svm_scrank"); return; }
    void naivesetGpnExt(Matrix<double> *GpnExtVal) { (void) GpnExtVal; NiceThrow("naivesetGpnExt blocked in svm_scrank"); return; }

    void setbiasdim(int xbiasdim, int addpos, double addval, int rempos) { (void) xbiasdim; (void) addpos; (void) addval; (void) rempos; NiceThrow("setbiasdim blocked in svm_scrank"); return; }
    void setBiasVMulti(const Vector<double> &nwbias) { (void) nwbias; NiceThrow("setBiasVMulti blocked in svm_scrank"); return; }

    void setgn(const Vector<double> &gnnew) { (void) gnnew; NiceThrow("setgn blocked in svm_scrank"); return; }
    void setGn(const Matrix<double> &Gnnew) { (void) Gnnew; NiceThrow("setGn blocked in svm_scrank"); return; }
...
inline double norm2(const SVM_ScRank &a);
inline double abs2 (const SVM_ScRank &a);

inline double norm2(const SVM_ScRank &a) { return a.RKHSnorm(); }
inline double abs2 (const SVM_ScRank &a) { return a.RKHSabs();  }
