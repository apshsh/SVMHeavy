...
int SVM_ScScor::qaddTrainingVector(int i, const gentype &zzz, SparseVector<gentype> &xxxx, double Cweigh, double epsweigh, int dval)
{
    int dd = dval; //2;
    ...
    if ( N() < SVM_Scalar::N() )
    {
        ...
        {
            if ( !(x(j).isf4indpresent(1)) && ( (int) x(j).f4(0) >= i ) )
            {
            ...
            else if ( x(j).isf4indpresent(1) && ( ( (int) x(j).f4(0) >= i ) || ( (int) x(j).f4(1) >= i ) ) )
            {
                SparseVector<gentype> xx(x(j));
...
int SVM_ScScor::setCweight(int i, double xxCweight)
{
    ...
    if ( N() < SVM_Scalar::N() )
    {
        ...
        for ( j = SVM_Scalar::N()-1 ; j >= N() ; --j )
        {
            if ( !(x(j).isf4indpresent(1)) && ( (int) x(j).f4(0) == i ) )
            {
                res |= SVM_Scalar::setCweight(j,Cweight()((int) x(j).f4(0)));
            }

            else if ( x(j).isf4indpresent(1) && ( ( (int) x(j).f4(0) == i ) || ( (int) x(j).f4(1) == i ) ) )
            {
                res |= SVM_Scalar::setCweight(j,Cweight()((int) x(j).f4(0))*Cweight()((int) x(j).f4(1)));
            }
        }
    }
...
int SVM_ScScor::setCweightfuzz(int i, double xxCweight)
{
    ...
    if ( N() < SVM_Scalar::N() )
    {
        ...
        for ( j = SVM_Scalar::N()-1 ; j >= N() ; --j )
        {
            if ( !(x(j).isf4indpresent(1)) && ( (int) x(j).f4(0) == i ) )
            {
                res |= SVM_Scalar::setCweightfuzz(j,Cweightfuzz()((int) x(j).f4(0)));
            }

            else if ( x(j).isf4indpresent(1) && ( ( (int) x(j).f4(0) == i ) || ( (int) x(j).f4(1) == i ) ) )
            {
                res |= SVM_Scalar::setCweightfuzz(j,Cweightfuzz()((int) x(j).f4(0))*Cweightfuzz()((int) x(j).f4(1)));
            }
        }
    }
...
int SVM_ScScor::setepsweight(int i, double xxepsweight)
{
    ...
    if ( N() < SVM_Scalar::N() )
    {
        ...
        for ( j = SVM_Scalar::N()-1 ; j >= N() ; --j )
        {
            if ( !(x(j).isf4indpresent(1)) && ( (int) x(j).f4(0) == i ) )
            {
                res |= SVM_Scalar::setepsweight(j,epsweight()((int) x(j).f4(0)));
            }

            else if ( x(j).isf4indpresent(1) && ( ( (int) x(j).f4(0) == i ) || ( (int) x(j).f4(1) == i ) ) )
            {
                res |= SVM_Scalar::setepsweight(j,epsweight()((int) x(j).f4(0))*epsweight()((int) x(j).f4(1)));
            }
        }
    }
...
int SVM_ScScor::addTrainingVector (int i, const gentype &z, const SparseVector<gentype> &x, double Cweigh, double epsweigh, int dval)
{
