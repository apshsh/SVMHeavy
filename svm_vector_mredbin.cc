...
//    }
    ...
    NiceThrow("Km (m>4) not defined for scalar_callback");
                             ...
                             int xdim, int densetype, int resmode, int mlid) const
{
    ...
    NiceThrow("K4 not defined for scalar_callback");
                             ...
                             int xdim, int densetype, int resmode, int mlid) const
{
    ...
    NiceThrow("K3 not defined for scalar_callback");
                             ...
                             int xdim, int densetype, int resmode, int mlid) const
{
    ...
    NiceThrow("K1 not defined for scalar_callback");
                             ...
                             int xdim, int densetype, int resmode, int mlid) const
{
    ...
    NiceThrow("K0 not defined for scalar_callback");
...
Vector<double> &SVM_Vector_Mredbin::dedgTrainingVector(Vector<double> &res, int i) const
{
...
Matrix<double> &SVM_Vector_Mredbin::dedKTrainingVector(Matrix<double> &res) const
{
    res.resize(N(),N());
...
Vector<double> &SVM_Vector_Mredbin::dedKTrainingVector(Vector<double> &res, int i) const
{
    NiceAssert( i < N() );
...
int SVM_Vector_Mredbin::gTrainingVector(Vector<double>  &res, int &dummy, int i, int retaltg, gentype ***pxyprodi) const
{
    (void) pxyprodi;
