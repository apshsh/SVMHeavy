...
inline double norm2(const SVM_VeRank &a);
inline double abs2 (const SVM_VeRank &a);

inline double norm2(const SVM_VeRank &a) { return a.RKHSnorm(); }
inline double abs2 (const SVM_VeRank &a) { return a.RKHSabs();  }
