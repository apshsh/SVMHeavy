...
inline double norm2(const SVM_VeScor &a);
inline double abs2 (const SVM_VeScor &a);

inline double norm2(const SVM_VeScor &a) { return a.RKHSnorm(); }
inline double abs2 (const SVM_VeScor &a) { return a.RKHSabs();  }
